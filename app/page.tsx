...
export default function Home() {
  return (
    <div className="bg-white">
      ...
      {/* ─── HERO ─── */}
      <section className="relative min-h-[90vh] flex items-center overflow-hidden px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-white via-blue-50/40 to-indigo-50/60">
        <div className="absolute inset-0 dot-grid opacity-60" />
        <div className="hero-glow w-[500px] h-[500px] bg-blue-400/10 top-1/4 -right-32" />

        <div className="relative z-10 max-w-7xl mx-auto w-full pt-20 pb-16 sm:pt-28 sm:pb-24">
          <div className="max-w-3xl">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 mb-6 px-3 py-1.5 rounded-full border border-blue-200 bg-blue-50 text-xs font-medium text-blue-700">
              <span className="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse-slow" />
              AI-First · Built on Google Cloud
            </div>

            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold leading-[1.06] tracking-tight text-slate-900 mb-6">
              Intelligent systems.<br />
              <span className="gradient-text">Unbreakable security.</span>
            </h1>

            <p className="text-base sm:text-xl text-slate-500 leading-relaxed max-w-2xl mb-10">
              Western Gate Labs builds AI-powered applications, hardens cybersecurity
              infrastructure, and delivers enterprise web platforms — powered by
            ...
            {/* Stats */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-10 pt-10 border-t border-slate-200">
              {stats.map((s) => (
                <div key={s.label}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-slate-500 text-sm sm:text-base leading-relaxed mb-8">
                This is a deliberate technical decision that gives our clients faster
                time-to-production, lower ML costs, and enterprise-grade reliability
                from day one.
              </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {techStack.map((tech) => {
                ...
                return (
                  <div key={tech.name} className="grad-border p-5 transition cursor-default">
                    <div className="w-8 h-8 rounded-lg bg-blue-50 flex items-center justify-center mb-3">
                      <Icon className="w-4 h-4 text-blue-600" />
                    </div>
                    <p className="text-sm font-semibold text-slate-900 mb-1">{tech.name}</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                {capabilities.map((cap) => {
                  ...
                  return (
                    <div key={cap.label} className="flex items-center gap-3">
                      ...
                      <span className="text-sm text-slate-700 font-medium">{cap.label}</span>
                    </div>
                  );
                })}
              </div>
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 shadow-sm">
              ...
              {[
                ...
                <div key={step.n} className={`flex gap-5 py-4 sm:py-5 ${idx < arr.length - 1 ? "border-b border-slate-100" : ""}`}>
                  <span className="text-xs font-mono text-blue-400 w-6 flex-shrink-0 mt-0.5">{step.n}</span>
                  <div>
                    <p className="text-sm font-semibold text-slate-900 mb-0.5">{step.label}</p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            <TestimonialCard
              ...
              author="Sarah Chen" title="CTO" company="TechCorp International"
            />
            <TestimonialCard
              ...
              author="Michael Rodriguez" title="VP Operations" company="Finance Plus"
            />
            <TestimonialCard
              ...
              author="Jennifer Park" title="Director of Security" company="Health Systems Inc"
            />
          </div>
        </div>
      </section>
      ...
      {/* ─── CTA ─── */}
      <section className="py-20 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-600 to-violet-700 relative overflow-hidden">
        <div className="hero-glow w-96 h-96 bg-white/10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/contact"
              className="px-7 py-3 text-sm font-semibold text-blue-700 bg-white rounded-lg hover:bg-blue-50 transition inline-flex items-center justify-center gap-2"
            >
              Book a consultation <ArrowRight className="w-4 h-4" />
            </Link>
            <Link
              href="/services"
              className="px-7 py-3 text-sm font-semibold text-white border border-white/40 rounded-lg hover:bg-white/10 transition inline-flex items-center justify-center"
            >
              View all services
            </Link>
          </div>
